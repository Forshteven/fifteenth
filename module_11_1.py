...
data_gmo = {
    ...
    'пазовые конструкции и закладные части ОВГ': ('15-05-2026', '15-06-2026'),
    'гидроприводы и затворы ОВГ': ('15-06-2026', '20-07-2026'),
    'пороги, пазовые конструкции и решётки СУР': ('20-06-2026', '20-07-2026'),
    'пороги и монтажные рамы подпятников ОДВ НГ': ('01-10-2025', '25-10-2025'),
    ...
    'вертикальная облицовка ОДВ НГ (2 ярус), подушки закладные (5-8 яруса)': ('04-04-2026', '30-04-2026'),
    'анкера гальсбантов ОДВ НГ': ('01-05-2026', '31-05-2026'),
    'створки ОДВ НГ': ('25-01-2026', '04-07-2026'),
    'гидроприводы и гальсбанты ОДВ НГ': ('04-07-2026', '20-07-2026'),
    'мостик пешеходный ОДВ НГ': ('20-08-2026', '05-09-2026'),
    'уплотнение ОДВ НГ': ('20-07-2026', '10-08-2026'),
    'рама отбойная ОДВ НГ': ('20-07-2026', '20-08-2026'),
    'пороги, колонны кронштейна, кронштейн закладной РДВ НГ': ('10-10-2025', '25-10-2025'),
    ...
    'створки РДВ НГ': ('15-01-2026', '20-07-2026'),
    'мостик пешеходный РДВ НГ': ('20-08-2026', '05-09-2026'),
    'уплотнение РДВ НГ': ('20-07-2026', '10-08-2026'),
    'рама отбойная РДВ НГ': ('20-07-2026', '20-08-2026'),
    'приспособление для подъёма створок в ремонтное положение': ('05-09-2026', '31-10-2026'),
    'секция 2 КШ закладные и рым': ('17-12-2025', '17-01-2026'),
